...
void main() {
  double hargaBelanja1, hargaBelanja2, hargaBelanja3, hargaBelanja4, totalHarga;
  ...
  totalHarga = double.parse(stdin.readLineSync()!);
  stdout.write("masukkan total Harga 5/n");
...
---------------------------------------------
            ...
            Tunai         = $totalHarga
            Kembalian     = $totalHarga - $totalBelanja
---------------------------------------------
''');
}